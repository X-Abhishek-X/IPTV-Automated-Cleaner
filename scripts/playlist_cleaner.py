...
def main():
    ...
    print(f"\n🔍 Total unique channels to check: {len(unique_entries)}")
    
    working_entries = []
    
    # 2. Validate Streams (Concurrent)
    print(f"🚀 Validating streams (Concurrent checks: {MAX_WORKERS})...")
        ...
        for future in concurrent.futures.as_completed(future_to_entry):
            ...
            try:
                ...
                if is_working:
                    ...
                    print(f"✅ [WORKING] {entry['url'][:50]}...") # Log working only to reduce noise
                else:
                     pass # print(f"❌ [DEAD] {entry['url'][:50]}...")
    ...
    # 3. Save Output
    print(f"\n📝 Writing clean playlist to {OUTPUT_FILE}...")
    ...
    print(f"🎉 Done! Saved {len(working_entries)} working channels.")
